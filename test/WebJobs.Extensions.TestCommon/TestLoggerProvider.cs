...
namespace Microsoft.Azure.WebJobs.Extensions.Tests.Common
{
    public class TestLoggerProvider : ILoggerProvider
    {
        ...
        private Dictionary<string, TestLogger> _loggerCache = new Dictionary<string, TestLogger>();
        ...
        public IEnumerable<LogMessage> GetAllUserLogMessages() => GetAllLogMessages().Where(p => userCategoryRegex.IsMatch(p.Category));
